...
Observando o gráfico acima podemos istinguir quais são os outliers. São episódios de fechamento de temporada, sendo o mais extremo deles, o final da série. Neste caso, vemos que os outliers não são valores meramente aleatórios. Alguns podem corroborar com alguma conjectura que queremos propor.
