...
ten_outliers_himym %>%
    ...
    geom_col()
```
Averiguando os outliers, comprovamos que os episódios mais avaliados foram, fatalmente, os da última temporada. Implicaria dizer que temos um final de série que as pessoas se envolveram bastante. 